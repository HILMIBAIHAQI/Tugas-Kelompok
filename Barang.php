...
<table border="1" cellpadding="5" cellspacing="0">
    ...
    <?php if (!empty($hasilCari)) : ?>
        ...
        <tr>
            ...
            <a href="<?= $_SERVER['PHP_SELF'] . '?aksi=hapus&key=' . $key ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus item ini?')">Hapus</a>
            </td>
        </tr>
    <?php endforeach; ?>
    <?php else : ?>
    <tr>
        <td colspan="5">Tidak ada data barang yang ditemukan.</td>
    </tr>
    <?php endif; ?>
</table>
</body>
